...
describe("ChatMessage", () => {
  ...
  it("handles long content with proper word breaking", () => {
    const message: Message = {
      ...
      type: "message",
      content:
        "This is a very long message that should wrap properly and not overflow the container boundaries when displayed in the chat interface",
      timestamp: Date.now(),
    };
    ...
    const messageElement = screen
      .getByText(/This is a very long message/)
      .closest("article");
    expect(messageElement).toBeTruthy();
  });
